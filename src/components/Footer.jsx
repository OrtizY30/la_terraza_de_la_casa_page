...
const Footer = () => {
  ...
  return (
    <footer className="footer flex flex-col justify-center items-center space-y-6 p-10 bg-neutral-800 -mb-28">
      ...
      <div onClick={scrollToTop} className="absolute bottom-5 right-5 hover:bg-orange-200/80 rounded-full flex cursor-pointer ">
      <box-icon name='up-arrow-alt' animation='flashing' color='#e2400e ' size='lg' ></box-icon>
      </div>
    </footer>
